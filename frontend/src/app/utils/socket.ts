...
export const getSocket = (): Socket => {
  if (!socket) {
    ...
    if (typeof window !== 'undefined' && 
        (window.location.hostname.includes('vercel.app') || rawSocketUrl.includes('studycircle-v2') || rawSocketUrl.includes('studycircle-backend'))) {
      rawSocketUrl = 'https://studycircle-v2.onrender.com';
    }
